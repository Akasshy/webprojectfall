...
<div class="container mt-5">
    <div class="row">
        <div class="d-flex mb-3">
            <h4 style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif">Produk Anda Cari</h4>
        ...
        <div class="col-2 me-4 mt-2 md-5">
          <div class="card" style="width:200px;height: 90%;">
              ...
              <div class="card-body ">
                  <p class="card-title " style="font-size: 17px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif">{{$item->nama_produk}}</p>
                  <p class="fw-bold">Rp.
                      {{$item->harga}}
                  </p>
                  <div class="d-flex">
